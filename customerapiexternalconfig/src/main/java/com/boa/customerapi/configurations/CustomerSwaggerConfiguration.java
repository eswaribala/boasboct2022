...
public class CustomerSwaggerConfiguration {
    ...
    public Docket api11Docket() {
        return new Docket(DocumentationType.SWAGGER_2)
        		.groupName("individual-api-1.1")
                .select()
                .apis(RequestHandlerSelectors
                        .basePackage("com.boa.customerapi"))
                .paths(PathSelectors.regex("/individuals/v1.1.*"))
                .build()
                .apiInfo(getApiInfo())
                .forCodeGeneration(true)
                .genericModelSubstitutes(ResponseEntity.class)
    ...
    @Bean
    public Docket api20Docket() {
        return new Docket(DocumentationType.SWAGGER_2)
        		.groupName("corporate-api-1.0")
                .select()
                .apis(RequestHandlerSelectors
                        .basePackage("com.boa.customerapi"))
                .paths(PathSelectors.regex("/corporates/v1.0.*"))
                .build()
                .apiInfo(getApiInfo())
                .forCodeGeneration(true)
                .genericModelSubstitutes(ResponseEntity.class)
    ...
    @Bean
    public Docket api21Docket() {
        return new Docket(DocumentationType.SWAGGER_2)
        		.groupName("corporate-api-1.1")
                .select()
                .apis(RequestHandlerSelectors
                        .basePackage("com.boa.customerapi"))
                .paths(PathSelectors.regex("/corporates/v1.1.*"))
                .build()
                .apiInfo(getApiInfo())
                .forCodeGeneration(true)
                .genericModelSubstitutes(ResponseEntity.class)
